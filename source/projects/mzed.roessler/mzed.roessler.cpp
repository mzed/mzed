/// @file
///	@ingroup 	mzed
///	@copyright	Copyright 2006-2021 Michael Zbyszyński  All rights reserved.
...
public:
    ...
    { 
        ...
        MIN_FUNCTION 
        {
            ...
            xNew = currentX + r_h * (-currentY - currentZ);
            yNew = currentY + r_h * (currentX + r_a * currentY);
            zNew = currentZ + r_h * (r_b + currentZ * (currentX - r_c));
